...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ws\x18\x04\x20\x03(\x0b2\x07.FollowR\x07follows\"C\n\x07Comment\x12$\n\
    \x08reply_to\x18\x01\x20\x01(\x0b2\t.ReplyRefR\x07replyTo\x12\x12\n\x04t\
    ext\x18\x02\x20\x01(\tR\x04text\"~\n\x08ReplyRef\x12\x20\n\x07user_id\
    \x18\x01\x20\x01(\x0b2\x07.UserIDR\x06userId\x12(\n\tsignature\x18\x02\
    \x20\x01(\x0b2\n.SignatureR\tsignature\x12&\n\titem_type\x18\x03\x20\x01\
    (\x0e2\t.ItemTypeR\x08itemType\"\x1a\n\x06Server\x12\x10\n\x03url\x18\
    \x01\x20\x01(\tR\x03url\"H\n\x06Follow\x12\x1b\n\x04user\x18\x01\x20\x01\
    (\x0b2\x07.UserIDR\x04user\x12!\n\x0cdisplay_name\x18\x02\x20\x01(\tR\
    \x0bdisplayName\"\x1e\n\x06UserID\x12\x14\n\x05bytes\x18\x01\x20\x01(\
    \x0cR\x05bytes\"!\n\tSignature\x12\x14\n\x05bytes\x18\x01\x20\x01(\x0cR\
    \x05bytes\"T\n\x08ItemList\x12$\n\x05items\x18\x01\x20\x03(\x0b2\x0e.Ite\
    mListEntryR\x05items\x12\"\n\rno_more_items\x18\x02\x20\x01(\x08R\x0bnoM\
    oreItems\"\xad\x01\n\rItemListEntry\x12\x20\n\x07user_id\x18\x01\x20\x01\
    (\x0b2\x07.UserIDR\x06userId\x12(\n\tsignature\x18\x02\x20\x01(\x0b2\n.S\
    ignatureR\tsignature\x12(\n\x10timestamp_ms_utc\x18\x03\x20\x01(\x03R\
    \x0etimestampMsUtc\x12&\n\titem_type\x18\x04\x20\x01(\x0e2\t.ItemTypeR\
    \x08itemType\"(\n\x0bAttachments\x12\x19\n\x04file\x18\x01\x20\x03(\x0b2\
    \x05.FileR\x04file\"B\n\x04File\x12\x12\n\x04hash\x18\x01\x20\x01(\x0cR\
    \x04hash\x12\x12\n\x04size\x18\x02\x20\x01(\x04R\x04size\x12\x12\n\x04na\
    me\x18\x03\x20\x01(\tR\x04name*;\n\x08ItemType\x12\x0b\n\x07UNKNOWN\x10\
    \0\x12\x08\n\x04POST\x10\x01\x12\x0b\n\x07PROFILE\x10\x02\x12\x0b\n\x07C\
    OMMENT\x10\x03b\x06proto3\
";
